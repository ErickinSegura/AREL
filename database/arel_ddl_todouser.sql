...
INSERT INTO TODOUSER.COLOR ( HEX_COLOR ) VALUES ( 'FFFFFF' );

INSERT INTO TODOUSER.COLOR ( HEX_COLOR ) VALUES ( 'AAAAAA' );
  ...
  --TODO:AGREGAR FK con color e icono nulleable
    ...
    CONSTRAINT FK_ICON_PROJECT FOREIGN KEY ( ID_ICON )
        REFERENCES TODOUSER.ICON ( ID_ICON )
            ON DELETE SET NULL,
    CONSTRAINT FK_ACTIVE_SPRINT FOREIGN KEY ( ACTIVE_SPRINT)
        REFERENCES TODOUSERSPRINT ( ID_SPRINT ) 
);
-- Sequence for autoincrement
